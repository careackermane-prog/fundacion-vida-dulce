          ...
          <div className="grid items-center gap-16 lg:grid-cols-2">
            ...
            >
              ...
              <p className="mt-8 max-w-xl text-xl leading-9 text-slate-200">
                ...
                Encuentra artículos sobre metabolismo, diabetes,
                alimentación saludable, tratamientos, prevención,
                ejercicio y consejos respaldados por información
                confiable para ayudarte a vivir mejor.
